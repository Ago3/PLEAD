...
LB_HATE_PRETRAIN = 0
LB_PRETRAINED = True
LB_EXPERIMENT_NAME = f'checkpoints_{LB_SIZE}_lr{LB_LR}_batch{LB_BATCH_SIZE}_beam{LB_BEAM}_maxLen{LB_MAX_LENGTH}_pretrained{LB_PRETRAINED}/'
LB_MODEL_DIR = LOG_DIR + 'litbart_plan/'
